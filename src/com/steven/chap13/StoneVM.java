...
import com.steven.stone.ast.ASTList;
import com.steven.stone.ast.ASTree;

import java.util.ArrayList;

import static com.steven.chap13.Opcode.*;
...
public class StoneVM {
    ...
    protected void mainLoop() {
        switch (code[pc]) {
            ...
            case BCONST:
                ...
                break;
            case SCONST:
                registers[decodeRegister(code[pc + 3])] = (int) code[pc + 2];
                pc += 4;
                break;
            case MOVE:
                moveValue();
    ...
    protected void moveValue() {
        ...
        if (isRegister(dest)) {
            ...
            stack[fp + decodeRegister(dest)] = value;
        }
        pc += 3;
    }
